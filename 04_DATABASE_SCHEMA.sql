...
-- ============================================================================
-- 10. NOTE TECNICHE E MIGRAZIONI
-- ============================================================================

-- COMMANDS SUPABASE CLI:
--   supabase migration new 001_initial_schema
--   supabase migration up
--   supabase db diff --file 001_initial_schema
--
-- BEST PRACTICES:
--   - Mai eseguire DDL direttamente su produzione.
--   - Ogni feature ha il proprio branch Supabase.
--   - Usare preview deployments per testare le migrazioni.
--   - Eseguire sempre supabase db diff prima del deploy.
--   - Mantenere questo file come SSOT (Single Source of Truth).
--
-- ORDINE MIGRAZIONI RACCOMANDATO:
--   001_initial_schema.sql  (questo file)
--   002_seed_knowledge.sql  (dati knowledge base giuridica)
--   003_seed_regions.sql    (regioni e città italiane per filter)
--   004_functions.sql       (funzioni PL/pgSQL custom)
--
-- ROLLBACK:
--   Per fare rollback di questa migrazione, eseguire:
--   supabase migration repair --status reverted 001_initial_schema
--
-- DEPENDENZE:
--   - pgvector: https://github.com/pgvector/pgvector
--   - uuid-ossp: built-in PostgreSQL contrib
--   - pgcrypto: built-in PostgreSQL contrib
--   - moddatetime: built-in PostgreSQL contrib (assicurarsi sia in shared_preload_libraries)
